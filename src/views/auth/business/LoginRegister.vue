...
function goToPhone() {
  router.push({ name: 'business-auth-phone' });
}
  ...
  <AuthPageLayout>
    ...
    >
      ...
      <div class="header-text">
        <h1 class="title">Welcome to Business</h1>
        <p class="subtitle">Manage your team, schedule, and bookings</p>
      </div>
      ...
      <div class="switch-row">
        <span class="switch-text">Are you a master?</span>
        <button
          class="switch-link"
          type="button"
          @click="switchToMaster"
        >
          Switch to Master
        </button>
      </div>
