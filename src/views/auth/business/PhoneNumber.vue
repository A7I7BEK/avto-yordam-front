...
async function sendCode() {
  ...
  try {
    ...
    const result = await businessAuth.loginWithPhone({ phone: fullPhone });
    router.push({
  ...
  <AuthPageLayout>
    ...
    >
      ...
      <div class="header-text">
        <h1 class="title">Enter your business phone</h1>
        <p class="subtitle">
          We'll send a verification code to your admin number
        </p>
      </div>
