<script
  ...
  lang="ts"
>
import { ArrowLeft, Mail, Phone, UserRound } from 'lucide-vue-next';
import { ref } from 'vue';
  ...
  <AuthPageLayout>
    ...
    >
      ...
      <div class="header-text">
        <h1 class="title">Welcome to Professional</h1>
      ...
      <div class="switch-row">
        <span class="switch-text">Are you an organization?</span>
        <button
          class="switch-link"
          type="button"
